...
export const settingPreset = {
  ...
  lmstudioAPIKey: inputSetting('', 'lmstudioAPIKey'),
  lmstudioBasePath: inputSetting('http://127.0.0.1:1234/v1', 'lmstudioBasePath'),
  lmstudioCustomModel: inputSetting('', 'lmstudioCustomModel'),
  lmstudioCustomModels: customModelsetting('lmstudioCustomModels', 'lmstudioCustomModel'),
  lmstudioTemperature: inputNumSetting(0.7, 'lmstudioTemperature', 'temperature'),
  lmstudioMaxTokens: inputNumSetting(800, 'lmstudioMaxTokens', 'maxTokens'),
  lmstudioModelSelect: selectSetting('qwen/qwen3.6-27b', 'lmstudioModel', availableModelsForLMStudio),
  enableHindsightTools: {
    defaultValue: false,
